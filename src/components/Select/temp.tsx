...
// Não mecha nisso aqui, estou pegando o codigo do cara e tentando modificar para usar o select com a mudança de cores ao tocar

// Também quero converter para o padrão do nosso projeto, styled component

// Se eu achar muito dificil eu vou recuar e tentar fazer do 0

// Vc também pode tentar fazer o mesmo, criar do 0
            ...
            {dropdown ? (
                <View style={[styles.wrapper, boxStyles]}>
                    ...
                    >
                        ...
                        {/* <AntDesign name="down" size={12} color={colorIcon} /> */}
