...
import { login as loginUserApi } from "../../services/login";
import { loginStorage } from "../../services/storage";
...
const schema = yup.object({
    ...
    email: yup
        ...
        .required("É nescessario enviar um e-mail"),
    password: yup
        .string()
        .min(7, "A senha deve conter mais de 7 caracteres")
        .required("É nescessario enviar uma senha forte"),
    password_confirmation: yup
        .string()
        .oneOf([yup.ref("password"), null], "As senhas devem ser iguais")
        .required("É nescessario confirma a senha"),
});
...
export default function Register() {
    ...
    async function handleNavigate() {
        try {
            ...
            const { access, refresh } = loginUserApi(obj);
            loginStorage({ access, refresh });
            login(user.id);
        } catch (err) {
    ...
    const listController = [
        ...
        {
            nameId: "password",
            props: { placeholder: "Senha", type: "password" },
        },
        {
            nameId: "password_confirmation",
            props: { placeholder: "Confirmar senha", type: "password" },
        },
    ];
